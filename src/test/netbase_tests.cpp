...
{
    BOOST_CHECK(TestSplitHost("www.bitpagar.com", "www.bitpagar.com", -1));
    BOOST_CHECK(TestSplitHost("[www.bitpagar.com]", "www.bitpagar.com", -1));
    BOOST_CHECK(TestSplitHost("www.bitpagar.com:80", "www.bitpagar.com", 80));
    BOOST_CHECK(TestSplitHost("[www.bitpagar.com]:80", "www.bitpagar.com", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:1965", "127.0.0.1", 1965));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:1965", "127.0.0.1", 1965));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:1965", "::ffff:127.0.0.1", 1965));
    BOOST_CHECK(TestSplitHost("[::]:1965", "::", 1965));
    BOOST_CHECK(TestSplitHost("::1965", "::1965", -1));
    BOOST_CHECK(TestSplitHost(":1965", "", 1965));
    BOOST_CHECK(TestSplitHost("[]:1965", "", 1965));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:1965", "127.0.0.1:1965"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:1965", "[::]:1965"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
